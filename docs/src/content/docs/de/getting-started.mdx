...
description: Data Mining »The Wheel of Time« Romane
---
...
Das Rad der Zeit ist eine Romanreihe, welche in den 1990ern vom us-amerikanischen Autoren Robert Jordan geschrieben wurde. Die Serie umfasst eine große Menge an Text und eignet sich daher sehr gut um Data Mining zu betreiben.

Als erstes installieren wir die Python-Bibliothek `BookNLP`:
